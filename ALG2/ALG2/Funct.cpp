...
int Array::getValue(int index) //Getting the value of array member
{
	return array[index];
}

char Char_Array::getValue(int index) //Getting the value of char array member
{
	return array[index];
}

int Array::correct()  //Part of the bogoSort
{
	int length2 = length;
	while (--length2 > 0)
...
void Array::shuffle() //Part of the bogoSort
{
